    ...
    return <>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="959" height="593"
            ...
            <g fill="#D3D3D3">
                ...
                <path className="state"
                      d="m935.2 512.9-1.8 1-2.6-1.3-.6-2.1-1.3-3.6-2.3-2.1-2.6-.6-1.6-4.8-2.7-6-4.2-1.9-2.1-1.9-1.3-2.6-2.1-2-2.3-1.3-2.3-2.9-3.1-2.3-4.5-1.8-.5-1.5-2.4-2.9-.5-1.5-3.4-5.2-3.4.2-4-2.4-1.3-1.3-.3-1.8.8-1.9 2.3-1-.3-2.1 6.1-2.6 9.1-4.5 7.3-.8 16.5-.5 2.3 1.9 1.6 3.2 4.4-.5 12.6-1.5 2.9.8 12.6 7.6 10.1 8.1-5.4 5.5-2.6 6.1-.5 6.3-1.6.8-1.1 2.7-2.4.6-2.1 3.6-2.7 2.7-2.3 3.4-1.6.8-3.6 3.4-2.9.2 1 3.2-5 5.5-2.3 1.6z"
                      id="south-carolina"
                ...
                <path className="state"
                      d="m1048.1 279.8-.5-4.2-.8-4.4-1.7-5.9 5.7-1.5 1.6 1.1 3.4 4.4 2.9 4.4-2.9 1.5-1.3-.2-1.1 1.8-2.4 1.9-2.9 1.1z"
                      id="rhode-island"
                      data-info="&lt;div&gt;State: Rhode Island&lt;/div&gt;&lt;div&gt;Capital: Providence&lt;/div&gt;"/>
                <path className="state"
                      d="m1047.2 280.1-.6-4.2-.8-4.4-1.6-6-4.2.9-21.8 4.8.6 3.3 1.5 7.3v8.1l-1.1 2.3 1.8 2.1 5-3.4 3.6-3.2 1.9-2.1.8.6 2.7-1.5 5.2-1.1 7-3.5z"
                      id="connecticut"
                ...
                <path className="state"
                      d="m1097.2 177.3 1.9 2.1 2.3 3.7v1.9l-2.1 4.7-1.9.6-3.4 3.1-4.8 5.5h-1.3c-.6 0-1-2.1-1-2.1l-1.8.2-1 1.5-2.4 1.5-1 1.5 1.6 1.5-.5.6-.5 2.7-1.9-.2v-1.6l-.3-1.3-1.5.3-1.8-3.2-2.1 1.3 1.3 1.5.3 1.1-.8 1.3.3 3.1.2 1.6-1.6 2.6-2.9.5-.3 2.9-5.3 3.1-1.3.5-1.6-1.5-3.1 3.6 1 3.2-1.5 1.3-.2 4.4-1.1 6.3-2.5-1.2-.5-3.1-3.9-1.1-.3-2.7-7.3-23.4-4.2-13.6 1.4-.1 1.5.4v-2.6l.8-5.5 2.6-4.7 1.5-4-1.9-2.4v-6l.8-1 .8-2.7-.2-1.5-.2-4.8 1.8-4.8 2.9-8.9 2.1-4.2h1.3l1.3.2v1.1l1.3 2.3 2.7.6.8-.8v-1l4-2.9 1.8-1.8 1.5.2 6 2.4 1.9 1 9.1 29.9h6l.8 1.9.2 4.8 2.9 2.3h.8l.2-.5-.5-1.1 2.8-.5zm-20.9 30.2 1.5-1.5 1.4 1.1.6 2.4-1.7.9-1.8-2.9zm6.7-5.9 1.8 1.9s1.3.1 1.3-.2.2-2 .2-2l.9-.8-.8-1.8-2 .7-1.4 2.2z"
                      id="maine"
                      data-info="&lt;div&gt;State: Maine&lt;/div&gt;&lt;div&gt;Capital: Augusta&lt;/div&gt;"/>
                <path className="state"
                      d="m1054.8 242.4.9-1.1 1.1-3.3-2.5-.9-.5-3.1-3.9-1.1-.3-2.7-7.3-23.4-4.6-14.5h-.9l-.6 1.6-.6-.5-1-1-1.5 1.9v5l.3 5.7 1.9 2.7v4l-3.7 5.1-2.6 1.1v1.1l1.1 1.8v8.6l-.8 9.2-.2 4.8 1 1.3-.2 4.5-.5 1.8 1.5.9 16.4-4.7 2.3-.6 1.5-2.6 3.7-1.6z"
                      id="new-hampshire"
                      data-info="&lt;div&gt;State: New Hampshire&lt;/div&gt;&lt;div&gt;Capital: Concord&lt;/div&gt;"/>
                <path className="state"
                      d="m1018.3 253.7-.8-5.7-2.4-10-.6-.3-2.9-1.3.8-2.9-.8-2.1-2.7-4.6 1-3.9-.8-5.2-2.4-6.5-.8-4.9 26.2-6.7.3 5.8 1.9 2.7v4l-3.7 4-2.6 1.1v1.1l1.1 1.8v8.6l-.8 9.2-.2 4.8 1 1.3-.2 4.5-.5 1.8.7 1.6-7 1.4-3.8.4z"
                      id="vermont"
                ...
                <path className="state"
                      d="m427 409.3-24.6-3.5-26.6-4.9-33.8-6 1.6-9.2 3.2-15.2L350 354l2.2-13.6 1.9-8.9 3.8-20.5 3.5-17.5 1.1-5.6 12.7 2.3 12 2.1 10.3 1.8 8.3 1.4 3.7.5-1.5 10.6-2.3 13.2 7.8.9 16.4 1.8 8.2.9-2.1 22-3.2 22.6-3.8 27.8-1.7 11.1-.3 2.4z"
                      id="utah"
                ...
                <path className="state"
                      d="m456.7 531-.7-6.1 8.6.5 29.5 3.1 28.4 1.4 2-22.3 3.7-55.9 1.1-19.4 2 .3v-11.1l-32.2-2.4-36.9-4.4-34.5-4.1-4.2 30.8-7 53.2-3.8 26.9-2 13.3 15.5 2 1.3-10 16.7 2.6 12.5 1.6z"
                      id="new-mexico"
                ...
                <path className="state"
                      d="m645.3 227.7-.4-7.5-2-7.3-1.8-13.6-.5-9.8-2-3.1-1.6-5.4v-10.3l.7-3.9-2.1-5.5-28.4-.6-18.6-.6-26.5-1.3-24.9-1.9-1.3 14.2-1.4 15.1-2.3 24.9-.5 11 56.8 3.8 56.8 1.8z"
                      id="north-dakota"
                      data-info="&lt;div&gt;State: North Dakota&lt;/div&gt;&lt;div&gt;Capital: Bismarck&lt;/div&gt;"/>
                <path className="state"
                      d="m646.8 303.2-1-1.1-1.5-3.6 1.8-3.7 1.1-5.6-2.6-2.1-.3-2.7.6-3 2.2-.8.3-5.7-.1-30.1-.6-3-4.1-3.6-1-2v-1.9l1.9-1.3 1.5-1.9.2-2.7-57.4-1.6-56.2-3.9-.8 5.3-1.6 15.9-1.3 17.9-1.6 24.6 16 1 19.6 1.1 18 1.3 23.8 1.3 10.7-.8 2.9 2.3 4.3 3 1 .8 3.5-.9 4-.3 2.7-.1 3.1 1.2 4.5 1.4 3.1 1.8.6 1.9.9 1.9.7-.5 1.1.2z"
                      id="south-dakota"
                ...
                <path className="state"
                      d="m765 445-3.8.9-6.2-.5.7-3 3.2-2.7.5-2.3-1.8-3-11 .5-20.8.9-23.3.7-23.5.5 1.6 6.9v8.2l1.4 11 .2 37.8 2.3 1.9 3-1.4 2.7 1.1.4 10.3 22.9-.1 18.9-.8 10.1-.2 1.1-2.1-.3-3.5-1.8-3 1.6-1.5-1.6-2.5.7-2.5 1.4-5.6 2.5-2.1-.7-2.3 3.7-5.4 2.7-1.4-.1-1.5-.3-1.8 2.9-5.6 2.4-1.3.4-3.4 1.8-1.2.9-4.2-1.3-4 4-2.4.6-2 1.2-4.3.7-3.1z"
                      id="arkansas"
                ...
                <path className="state"
                      d="m677.4 425.1-12.6.2-46.1-.5-44.6-2.1-24.6-1.3 4.1-64.7 21.8.8 40.5 1.4 44.1.5h5.1l3.2 3.2 2.8.2.9 1.1v2l-1.8 1.6-.5 2.6 2.2 3.6 2.5 3.1 2.5 2L678 390l-.6 35.1z"
                      id="kansas"
                ...
                <path className="state" d="m975.8 353.8-1.1-1.6-1-.8 1.1-1.6 2.2 1.5-1.2 2.5z"/>
                <circle className="state" cx="975.3" cy="351.8" r="5" stroke="#FFF" strokeWidth="1.5"
                        id="washington-dc" data-info="&lt;div&gt;Washington DC&lt;/div&gt;"/>
            </g>
            <path className="state" fill="none" stroke="#A9A9A9" strokeWidth="2"
